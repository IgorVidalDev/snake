...
import spypunk.snake.ui.controller.command.cache.SnakeControllerCommandCacheImpl;
...
public class SnakeModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(SnakeControllerCommandCache.class).to(SnakeControllerCommandCacheImpl.class);
